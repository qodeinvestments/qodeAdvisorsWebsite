...
async function verifyRecaptchaToken(token, recaptchaAction = 'SUBMIT_FORM') {
  try {
    ...
    process.env.GOOGLE_APPLICATION_CREDENTIALS = path.join(__dirname, '../config/recaptcha.json');
...
module.exports = { verifyRecaptchaToken };const { RecaptchaEnterpriseServiceClient } = require('@google-cloud/recaptcha-enterprise');
const path = require('path');
