...
const articles = [
    {
        ...
        excerpt:
          "By imposing heavy taxes on F&O transactions, the government is not really helping the retail trader. If taxes such as STT, stamp duty, and high broker fees were reduced or eliminated, many retail traders could become profitable. However, doing so would lead to a significant loss of revenue for the government,",
          additionalParagraph:"Approximately 11.3 million distinct individual traders together incurred losses of Rs 1.81 lakh crore from FY22 to FY24. Merely 7.2 per cent of individual F&O traders reported a profit during the three-year timeframe, with only 1 per cent earning more than Rs 1 lakh once transaction costs were considered. According to the report by Sebi, over 75 per cent of the loss-making traders continued to operate in the F&O segment even after incurring losses in the previous two consecutive years. If the government’s true intention is to discourage speculative trading among retail investors, the solution is simple: increase the net worth requirements for individuals to trade in futures and options. In its attempt to curb retail trading through higher taxes and charges, the government may ultimately be causing more harm than good, Nahar added.",
