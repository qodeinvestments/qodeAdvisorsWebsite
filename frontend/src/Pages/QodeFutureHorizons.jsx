...
const QodeFutureHorizons = () => {
  return (
    <>
      <Helmet>
        <title>Qode Future Horizons - Precision Stock Picking</title>
        <meta
          name="description"
          content="Qode Future Horizons employs a data-driven stock screening model to identify market outperformers with multibagger potential."
        />
        <meta
          name="keywords"
          content="Qode Future Horizons, stock screening, quantitative investing, small-mid-cap stocks, data-driven models, multibagger stocks"
        />
        <meta name="author" content="Qode Invest" />
        <link rel="canonical" href="https://www.qodeinvest.com/qode-future-horizons" />
      </Helmet>
