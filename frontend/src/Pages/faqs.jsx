  ...
  return (
    <div className="bg-white border mb-2">
      ...
      >
        <Heading
          level={3}
          className="text-base  font-medium sm:text-body md:sm:text-subheading text-mobileSubHeadingtext-brown pr-4"
        >
          {question}
        </Heading>
        <span
          className={`text-brown md:sm:text-subheading text-mobileSubHeadingsm:md:sm:text-subheading text-mobileSubHeadingtransition-transform duration-300 ${
