...
const StrategyCard = ({ title, description, link }) => (
  <Link to={link} className="text-black w-full group">
    <div className="p-2 transition-all duration-300 h-[170px] hover:bg-beige group-hover:text-black bg-lightBeige border border-brown hover:shadow-2xl relative flex flex-col sm:h-full">
