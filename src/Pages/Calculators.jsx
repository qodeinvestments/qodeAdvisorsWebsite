  ...
  return (
    <div className="bg-white graphik-font-regular min-h-screen">
      <div className="bg-gray-100 text-center text-black py-44">
        <Container>
          <h1 className="text-4xl font-bold mb-4">Strategy Calculators</h1>
          <p className="text-xl">Explore and calculate returns for various investment strategies</p>
        </Container>
      </div>

      <Container>
        <div className="my-12">
          <h2 className="text-2xl font-semibold text-gray-700 mb-6">Choose a Strategy</h2>
