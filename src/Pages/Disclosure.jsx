    ...
    <Container>
      <div className="flex flex-col  items-center justify-center min-h-screen  p-6">
        <div className="bg-white  p-8 rounded-lg  mx-auto mt-10">
          <h1 className="font-black mt-20 sophia-pro-font text-6xl text-start mb-4">
            Disclosure
          </h1>
          ...
          <div className="flex  justify-center mt-10 flex-col gap-20">
            <div className="bg-[#fafafa] flex p-20 gap-20">
              <div className="w-44 h-52 bg-red-50"></div>
              <div>
                <h1 className="text-3xl font-extrabold sophia-pro-font">
          ...
          <div className="minion-pro-font text-xl space-y-10 mt-10">
            <p>
