  ...
  return (
    <div className=" mx-auto p-6 bg-white shadow-md rounded-lg">
      ...
      <div className="mt-6 p-4 bg-white rounded-lg shadow-sm border-l-4 border-gray-500">
        <h2 className="text-xl font-semibold text-gray-600">Introduction</h2>
        <p>
      ...
      <div className="mt-4 p-4 bg-white rounded-lg shadow-sm border-l-4 border-gray-500">
        <h2 className="text-xl font-semibold text-gray-600">Benefits</h2>
      ...
      <div className="mt-4 p-4 bg-white rounded-lg shadow-sm border-l-4 border-gray-500">
        <h2 className="text-xl font-semibold text-gray-600">Risks</h2>
        <ul className="list-disc pl-5 space-y-2">
          <li>
      ...
      <div className="mt-4 p-4 bg-gray-100 rounded-lg shadow-sm border-l-4 border-gray-500">
        <h2 className="text-xl font-semibold text-gray-600">Conclusion</h2>
        <p>
